...
To set the device in monitoring mode, its first plugged into a computer, raspberry pie or similar and then the following four CLI-commands were applied on the sniffer:
