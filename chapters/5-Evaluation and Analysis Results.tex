...
\begin{figure}[H]
    ...
    \centering
        ...
        \end{subfigure}
    \caption{Netatmo: Graphs from cooking events shown in packets with events in red and baseline in blue - 1}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Netatmo: Graphs from cooking events shown in packets with events in red and baseline in blue - 2}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Netatmo: Graphs from cooking events shown in bytes with events in red and baseline in blue - 2}
