...
The evaluation and analysis result chapter presents all gathered and analyzed data from the four different tests carried out in this thesis. The chapter first shows a general procedure applicable for all test cases, then the results from each test case are presented in separate subsections. 
